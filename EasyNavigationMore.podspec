...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/gs01md/EasyNavigationMore"
  s.license      = "MIT"
  s.author       = { "chenliangloveyou" => "ios_elite@163.com" }
  s.source       = { :git => "https://github.com/gs01md/EasyNavigationMore.git", :tag => "#{s.version}"}
  s.source_files = "EasyNavigationMore/**/*"
  s.resource     = 'EasyNavigationMore/EasyNavButton.bundle'
